...
- [`2026-09-05-ironlint-v1-implementation`](2026-09-05-ironlint-v1-implementation.md) — in progress: versioned core/CLI path implemented; external acceptance, feedback adapter, migration, teardown, and release gates remain open.
